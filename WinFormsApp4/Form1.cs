    ...
    int nWidthEllipse, int nHeightEllipse);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text != "" && textBox3.Text != "")
            {
                ...
                using (var conn = new NpgsqlConnection("Host=localhost;Port=5432;Username=postgres;Password=Gun180106;Database=anjir"))
                {
                    conn.Open();
        ...
        {
            NpgsqlConnection conn = new NpgsqlConnection("Host=localhost;Username=postgres;Password=Gun180106;Database=anjir;port = 5432");
            conn.Open();
